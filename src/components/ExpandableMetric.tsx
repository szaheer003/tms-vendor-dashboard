  ...
  return (
    <div>
      ...
      >
        ...
        <span className="text-caption text-[#94A3B8]">{label}</span>
        <span className="text-micro text-[#94A3B8]">{open ? "▾" : "▸"}</span>
      </button>
      {open && (
        <div className="mt-2 ml-0 sm:ml-4 rounded-[12px] border border-[#E2E8F0] bg-[#F8FAFC] p-4 text-body text-[#64748B] animate-page-in">
          {detail}
        </div>
      )}
    </div>
